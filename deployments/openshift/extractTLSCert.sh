...
extractTLSCert()
{
    ...
    EXTRACT_CERT_CMD_RUN="oc extract secret/$KAFKA_CLUSTER_NAME-cluster-ca-cert --keys=ca.crt --to=tls --confirm -n $OPENSHIFT_NAMESPACE"
    ...
    KEYTOOL_IMPORT_CMD_RUN="keytool -import -trustcacerts -alias root -file tls/ca.crt -keystore tls/truststore.jks -storepass password -noprompt"
