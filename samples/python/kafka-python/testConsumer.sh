...
main()
{
    ...
    case $PLATFORM_OPTION in
		1)  KAFKA_BROKER=$BOOTSTRAP_SERVER TOPIC=$KAFKA_TOPIC python3 testConsumer.py
			;;
        2)  KAFKA_BROKER=$BOOTSTRAP_SERVER SSL=true TOPIC=$KAFKA_TOPIC python3 testConsumer.py
            ;;
